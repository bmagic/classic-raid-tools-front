            ...
            <div key={character._id} className='level is-mobile'>
              ...
              <div className='level-right'>
                ...
                <div className='level-item'>
                  ...
                  <button onClick={() => this.onClick(character._id, 'late', favorite)} className={`button is-small ${status === 'late' ? 'is-warning' : ''}`} title='Disponible mais en retard ou tentative pour être là'><i className="fas fa-clock"/></button>
